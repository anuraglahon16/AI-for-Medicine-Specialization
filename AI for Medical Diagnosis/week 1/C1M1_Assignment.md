...
def check_for_leakage(df1, df2, patient_col):
    ...
    patients_in_both_groups = (list(set(df1_patients_unique) & set(df2_patients_unique)))

    # leakage contains true if there is patient overlap, otherwise false.
    leakage = False if patients_in_both_groups ==  [] else True # boolean (true if there is at least 1 patient in both groups)
